...
\begin{itemize}
	...
	serving as the basis for all testing activities. Symbolic constants used
	throughout the V\&V Plan can be found in Section 10 of the SRS.
	\item
...
\begin{enumerate}
	...
	\begin{itemize}
		...
		\item \textbf{Coverage Goal}: Achieve >\textit{MIN\_CODE\_COVERAGE} (see
		Section 10 of
...
the model has a precision of at least \textit{CATEGORIZATION\_ACCURACY}\% (see
Section 10 of
\href{https://github.com/PlutosCapstone/Plutos/blob/main/docs/SRS/SRS.pdf}{SRS}).
