...
\subsection{Normal Operation}\label{sec_NormalOperation}

Figure \ref{fig_UseCaseDiagram} shows the use case diagram for the system, under 
normal operation.
