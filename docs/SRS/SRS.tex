...
\begin{enumerate}[label=NFR\arabic*]
  ...
  \item (H) The OCR must achieve at least
  \hyperref[Table:AuxConstants]{\textit{OCR\_ACCURACY}}\% accuracy in correctly
  identifying and extracting key information (i.e., item names, quantities,
