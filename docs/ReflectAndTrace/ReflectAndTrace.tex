...
\begin{table}[H]
    ...
    \toprule 
        ...
        \midrule
        % TA 
        \href{https://github.com/PlutosCapstone/Plutos/issues/233}{233} & Peer
        Review & docs(design): add tests to CI & $\checkmark$ &
        \href{https://github.com/PlutosCapstone/Plutos/pull/262}{262}, \href{https://github.com/PlutosCapstone/Plutos/pull/264}{264},
        \href{https://github.com/PlutosCapstone/Plutos/pull/258}{258} & Added
        tests to CI  \\ \hline
        \href{https://github.com/PlutosCapstone/Plutos/issues/234}{234} & Peer
        Review & docs(design): DetDesDoc syntax - change naming and data types &
        $\checkmark$ &
        \href{https://github.com/PlutosCapstone/Plutos/pull/247}{247} &  Added
        suggested changes \\
        \hline
        \href{https://github.com/PlutosCapstone/Plutos/issues/235}{235} & Peer
        Review & docs(design): DetDesDoc syntax - add transaction class &  &
        \href{https://github.com/PlutosCapstone/Plutos/pull/x}{x} &   \\ \hline
        \href{https://github.com/PlutosCapstone/Plutos/issues/236}{236} & Peer
        Review & docs(design): DetDesDoc semantics - add more details to
        ML/categorization module & $\checkmark$ &
        \href{https://github.com/PlutosCapstone/Plutos/pull/247}{247} &  Adedd
        details \\ \hline
        \href{https://github.com/PlutosCapstone/Plutos/issues/237}{237} & Peer
        Review & docs(design): DetDesDoc semantics - add details about
        calculations & $\checkmark$ &
        \href{https://github.com/PlutosCapstone/Plutos/pull/247}{247} & Added
