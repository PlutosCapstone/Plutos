...
\begin{table}[H]
    ...
    \toprule 
        ...
        docs(SRS): Add fit criterions to requirements &  &
        \href{https://github.com/PlutosCapstone/Plutos/pull/x}{x} &   \\ \hline
        \href{https://github.com/PlutosCapstone/Plutos/issues/109}{109} & TA &
        docs(SRS): Link requirements to rationale section &  &
        \href{https://github.com/PlutosCapstone/Plutos/pull/x}{x} &   \\ \hline
...
\begin{table}[H]
    ...
    \toprule 
        ...
        \href{https://github.com/PlutosCapstone/Plutos/pull/301}{301} &  Adjusted
        DAG diagram \\ \hline
        ...
        \href{https://github.com/PlutosCapstone/Plutos/pull/301}{301} &  Added
        ...
        \href{https://github.com/PlutosCapstone/Plutos/pull/301}{301} &  Added
        exception handling section for item misclassification \\
        % USE THIS FOR COPYING:
        % \href{https://github.com/PlutosCapstone/Plutos/issues/x}{x} & Peer
        % Review &  &  & \href{https://github.com/PlutosCapstone/Plutos/pull/x}{x}
        % &   \\ 
